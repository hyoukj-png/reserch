...
### 1. 완전성
기대 산출물 8종이 모두 존재하고 비어있지 않은가:
`05-components.md`, `07-performance-a11y.md`, `08-renewal-insights.md`, `BENCHMARK_RECIPE.md`, `MASTER_REPLICATION_PROMPT.md`, `PRD.md`, `FRD.md`, `COMPLETION_REPORT.md`. 누락 시 책임 에이전트 명시.
