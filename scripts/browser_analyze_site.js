  ...
  try {
    for (const pageUrl of pages) {
      ...
      try {
        ...
        results.push({ url: pageUrl, error: error.message, initial: { title: "", clickables: [], dialogs: [], hiddenDialogs: [], forms: [] }, screenshots: {}, network: { byType: {}, thirdParty: [] }, consoleErrors: [], clickStates: [], styleSamples: [], sectionRoles: { sections: [], counts: {}, readingOrder: [] }, swiperStates: [], hoverPanels: [], coverage: null });
      }
    }
  } finally {
